...
suffix=paste('_6feats', args[1], '.Rda', sep='')
...
df_weak = read.csv(paste(outdir, "/training_labels.csv", sep = ""))
...
phot.master = phot.master[,!names(phot.master) %in% c("FLUX_RADIUS", "zY", "YJ", "JH")]
